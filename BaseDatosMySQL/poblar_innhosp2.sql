...
--   Turnos, plantilla, plantilla_turno,
...
-- Columnas: id_servicio, nombre, semanas (ciclo semanal)
-- ==============================================================
INSERT INTO plantilla (id_servicio, nombre, semanas) VALUES
(1, 'Plantilla Estándar - Medicina Interna', 4),
(2, 'Plantilla Estándar - Enfermería',        4),
(3, 'Plantilla Estándar - Cirugía',           2);

-- ==============================================================
-- 9. PLANTILLA_TURNO  →  tabla: plantilla_turno
-- Tipos de turno reutilizables por plantilla.
-- hora_termino usa nombre de columna en la entidad: hora_termino
-- ==============================================================
INSERT INTO plantilla_turno (id_plantilla, hora_inicio, hora_termino, nombre) VALUES
-- Plantilla 1 — Medicina Interna
(1, '08:00:00', '20:00:00', 'Turno Diurno'),
(1, '20:00:00', '08:00:00', 'Turno Nocturno'),
-- Plantilla 2 — Enfermería
(2, '08:00:00', '20:00:00', 'Turno Diurno'),
(2, '20:00:00', '08:00:00', 'Turno Nocturno'),
-- Plantilla 3 — Cirugía
(3, '08:00:00', '20:00:00', 'Turno Diurno'),
(3, '20:00:00', '08:00:00', 'Turno Nocturno');

-- ==============================================================
-- 10. TURNOS  →  tabla: Turnos
...
-- ==============================================================
-- 11. SOLICITUDES  →  tabla: Solicitudes
...
-- ==============================================================
-- 12. NOTIFICACION2  →  tabla: Notificacion2
...
-- ==============================================================
-- 13. BITACORA_EVENTOS  →  tabla: Bitacora_eventos
