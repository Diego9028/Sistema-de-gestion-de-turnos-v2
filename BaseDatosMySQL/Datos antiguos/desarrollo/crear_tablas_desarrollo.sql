...
DROP TABLE IF EXISTS servicio_sgt_huap;
...
-- ============================================
-- Tabla: servicio_sgt_huap
-- ============================================
CREATE TABLE servicio_sgt_huap (
    id_servicio_ext BIGINT NOT NULL PRIMARY KEY, -- CAMBIADO: BIGINT en lugar de INT
    id_responsable BIGINT NULL, -- CAMBIADO: BIGINT en lugar de INT
    id_subrogante BIGINT NULL, -- CAMBIADO: BIGINT en lugar de INT
    piso_principal VARCHAR(50), -- Ejemplo de dato extra que podrías necesitar
    
    -- Relación con la tabla maestra original
    CONSTRAINT fk_ext_servicio_original 
        FOREIGN KEY (id_servicio_ext) REFERENCES servicio(id_servicio)
        ON DELETE CASCADE,
        
    -- Relación con tu tabla de personal
