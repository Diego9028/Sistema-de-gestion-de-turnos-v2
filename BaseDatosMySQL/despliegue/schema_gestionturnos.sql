...
-- ==============================================================
-- Solo ESTRUCTURA (sin datos). Crea la base gestionturnos y todas
-- sus tablas. Úsalo cuando la carga de datos corre por separado:
--   - Entrega al hospital: ellos crean la BD con este script y
--     cargan sus propios datos.
--   - DDL_AUTO=validate: la estructura debe existir antes de
--     arrancar el backend.
--
-- Para simular un despliegue completo (estructura + datos
-- de prueba) usa despliegue/setup_gestionturnos.sql en su lugar.
--
-- Ejecución:
--   mysql -u root -p < BaseDatosMySQL/despliegue/schema_gestionturnos.sql
-- ==============================================================
